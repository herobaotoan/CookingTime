...
public class PowerupFastProcess : MonoBehaviourPun
{   
    ...
    {
        board1.GetComponent<ChangeSprite>().SetIsBonus(state);
        board2.GetComponent<ChangeSprite>().SetIsBonus(state);
        pan1.GetComponent<ChangeSprite>().SetIsBonus(state);
        pan2.GetComponent<ChangeSprite>().SetIsBonus(state);
    }
